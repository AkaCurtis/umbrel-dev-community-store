...
- **AxeBCH2** (`willitmod-dev-axebch2`) - `0.1.40-alpha`
...
- XEC node runs from `ghcr.io/willitmod/axexec-node` (pinned by version tag in `docker-compose.yml`; image is built from official Bitcoin ABC release tarballs).
